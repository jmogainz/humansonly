...
function MoreMenuModal({
  ...
  useEffect(() => {
    ...
    const handleClickOutside = (e: MouseEvent) => {
      ...
      // Don't close if clicking inside the menu dropdown itself
    ...
    // Use click to avoid race conditions with the toggle button
  ...
  // Prevent flicker: don't render until we have a position
